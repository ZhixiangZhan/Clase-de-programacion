...
while var4=="s":
    ...
    while total_acumulado<21:
        while var6=="s":
            ...
            var6
            =input("Quieres otra carta? si: s  no: n :")
    ...
    if var6=="n":            
        while total_acumulado1>total_acumulado:
            var2=random.randint(1,13)
            var3=var1[var2-1]
        ...
        #    print(f"La banca ha ganado con un total acomulado de {total_acumulado1}")
         #   var4=input("Quiere jugar otra partida de blackjack? si: s  no: n :")
        #if total_acumulado1<21 and total_acumulado>total_acumulado1:
         #   print(f"Usted ha ganado con un total acomulado de {total_acumulado}")
          #  var4=input("Quiere jugar otra partida de blackjack? si: s  no: n :")
